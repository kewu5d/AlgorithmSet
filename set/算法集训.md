...
- 使用c++语言可以将cincout换成printf、scanf
...
- <font color=red>重要思路</font>：求最（大）值问题——==倒着枚举==，找到的第一个符合答案即最终答案
...
1. [lg1003](https://www.luogu.com.cn/problem/P1003)
  ...
  - 找思路，代码实现
  	- 思路：
        	    ...
        	    - （因为后覆盖的地毯在上面，后来居上，而题目正好要求最上面的地毯），如果有一个地毯满足条件就直接输出，并退出。如果没有地毯满足条件，就输出-1。
